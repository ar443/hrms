        ...
        <li class="dropdown dropdown-fuse">
            <a href="#" class="dropdown-toggle fw600" data-toggle="dropdown">
                ...
                @if(isset(\Auth::user()->employee->photo))
                    <img src="{{Auth::user()->employee->photo ? asset('photos/'.\Auth::user()->employee->photo) : '/assets/img/avatars/profile_pic.png'}}" width="50px" height="50px" alt="avatar" class="mw55">
                @else
